...
import VotingContract from './assets/contracts/Voting.json';
    ...
    methods: {
        ...
        init() {
            ...
            if (window.bc == undefined) {
                ...
                // connecting to the blockchain and intializing the Voting smart contract
        ...
        isRegistered() {
            return new Promise((resolve, reject) => {
                ...
                .then(account => {
                    window.bc.contract().isVoter( account, (error, res) => {
